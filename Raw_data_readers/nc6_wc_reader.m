%Class for handle 'nc6' files. Wave_clus uses the first letters of the m file to now what files it can open.
%
...
classdef nc6_wc_reader < handle
	...
	methods 
        function obj = nc6_wc_reader(par, raw_filename)
            load('NSX_TimeStamps','ns6');
            sr = ns6.sr;
            lts = ns6.lts;
            obj.sr = sr;
